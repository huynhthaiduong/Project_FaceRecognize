...
UltraFace::UltraFace(const std::string &bin_path, const std::string &param_path,
    ...
    ultraface.load_param("retinaface_full.param");
    ultraface.load_model("retinaface_full.bin");
    arcface.opt.use_vulkan_compute =1;
    arcface.load_param("mobilefacenet.param");
    arcface.load_model("mobilefacenet.bin");
