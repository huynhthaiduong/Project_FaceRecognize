...
#if NCNN_VULKAN
ncnn::VulkanDevice* UltraFace::g_vkdev = ncnn::get_gpu_device(0);
ncnn::VkAllocator *UltraFace::g_blob_vkallocator = new ncnn::VkBlobBufferAllocator(UltraFace::g_vkdev);
ncnn::VkAllocator  *UltraFace::g_staging_vkallocator = new ncnn::VkStagingBufferAllocator(UltraFace::g_vkdev);
#endif
ncnn::UnlockedPoolAllocator UltraFace::g_blob_pool_allocator;
ncnn::PoolAllocator UltraFace::g_workspace_pool_allocator;
ncnn::Net UltraFace::arcface;
UltraFace::init_static UltraFace::s_initializer;
...
//    arcface.load_model("/home/nghiep/Documents/c_face_rec/build/mobilefacenet.bin");
    ...
    ultraface.load_param("/home/nghiep/Documents/c_face_rec/build/retinaface_full.param");
    ultraface.load_model("/home/nghiep/Documents/c_face_rec/build/retinaface_full.bin");
...
//#endif
    ...
    ncnn::Mat flattened_out = score.reshape(score.w * score.h * score.c);
    const float* ptr_score = flattened_out;
    float l2 = 0;
